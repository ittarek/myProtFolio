...
const bestProjects = [
  {
    ...
    description:
      'A comprehensive Saral Tech Venture Builder platform with interactive Sections, progress tracking, and gamified user experiences. Built with modern web technologies by Next.js for optimal user engagement.',
    image: saralTech,
  ...
  },
  {
    ...
    subtitle: 'UAE Based Travel Booking Platform',
    description:
    ...
    image: travent,
    tags: ['React', 'TailwindCSS', 'Cloudflare', 'React Hook', 'Laravel'],
...
// Best Project Card Component
const BestProjectCard = ({ project }) => {
        ...
        <div className="best_projects_section mb-24">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto">
            {bestProjects.map(project => (
              <BestProjectCard key={project.id} project={project} />
            ))}
          </div>
        </div>
