      ...
      <div ref={containerRef} className="py-16 md:py-24">
        ...
        <div ref={headingRef} className="text-center mb-16">
          ...
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            A comprehensive overview of technologies and tools I've mastered throughout my
            development journey.
          </p>
        </div>
                ...
                {category.items.map((item, itemIdx) => (
                  <div key={itemIdx} className="tech-item">
                    ...
                    <div className="h-2 bg-slate-700/50 rounded-full overflow-hidden">
                      <div
                        className={`h-full bg-gradient-to-r ${getLevelColor(item.level)} rounded-full`}
                        style={{
                          width:
                            item.level === 'Expert'
                              ? '90%'
        ...
        <div className="text-center mt-16 p-8 rounded-xl bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
          <p className="text-gray-300">
            Always learning and exploring new technologies to stay at the forefront of web
            development.
          </p>
        </div>
      </div>
