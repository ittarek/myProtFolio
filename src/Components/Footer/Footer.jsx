  ...
  return (
    <footer className=" border-t-2 border-gray-700">
      <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
        <nav
          className="-mx-5 -my-2 flex flex-wrap  text-gray-300 justify-center"
          aria-label="Footer">
          ...
          <div className="px-5 py-2">
            <Link to="/about" className="text-base  hover:text-gray-400">
              About
            </Link>
          </div>

          <div className="px-5 py-2">
            <Link to="/myProtFolio" className="text-base hover:text-gray-400">
              Portfolio
            </Link>
          </div>
          <div className="px-5 py-2 cursor-pointer">
            <div onClick={handleDownload} className="text-base hover:text-gray-400">
              Resume
            </div>
          </div>
        </nav>
